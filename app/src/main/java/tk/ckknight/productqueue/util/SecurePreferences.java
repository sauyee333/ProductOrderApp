...
public class SecurePreferences implements SharedPreferences {
    ...
    public String getString(String key, String defaultValue) {
        ...
        final String decryptValue = decrypt(encryptedValue);
        return (decryptValue != null) ? decryptValue : defaultValue;
    }
     ...
     */
    public void registerOnSharedPreferenceChangeListener(
            final SharedPreferences.OnSharedPreferenceChangeListener listener, boolean decryptKeys) {
